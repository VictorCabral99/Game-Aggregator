    ...
    <main className="min-h-screen p-8">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-400 mb-8">
          Biblioteca com notas da comunidade. Wishlist com promoções em um só lugar.
        </p>

        <button
          onClick={() => signIn('google')}
          className="bg-white hover:bg-gray-100 text-gray-800 font-bold py-3 px-6 rounded-lg inline-flex items-center gap-3 transition-colors"
        >
